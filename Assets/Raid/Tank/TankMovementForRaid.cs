...
namespace Complete
{
    public class TankMovementForRaid : MonoBehaviourPun
    {
        ...
        //砲塔の制御のための変数
        public float m_TurretRotationInput;         // 砲塔を回転するキーの入力量の変数
        public float m_TurretRotationSpeed;         // 砲塔の回転速度の変数
        private string m_TurretRotationName;        // 砲塔を回転するキーの名前
        ...
        private void OnEnable()
        {
            ...
            m_TurretRotationInput = 0f;               //砲塔を回転するキーの入力量のリセット
